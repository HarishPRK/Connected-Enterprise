...
const nav = [
  ...
  { to: '/path-selection',   label: 'Dynamic Path Selection',    icon: GitBranch,       section: 'Routing' },
  { to: '/app-routing',      label: 'Application Aware Routing', icon: Layers,          section: 'Routing' },
