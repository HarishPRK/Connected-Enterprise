/**
 * Type definitions for the Dynamic Failover integration pack.
 * Strict superset of the IT/OT devices pack's types.ts (Status, Device,
 * DeviceTelemetry, HealthSignal, DeviceHealth, FleetStat — needed by the
 * useDevices hook) plus the IPsec / Cellular / Path family extracted
