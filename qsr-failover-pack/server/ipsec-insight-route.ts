/**
 * POST /api/ipsec/insight — lifted verbatim from the main app's server/index.ts
 * and wrapped in a registrar so a host Express app can mount it with a single
 * call: `registerIpsecInsightRoute(app)`.
 *
